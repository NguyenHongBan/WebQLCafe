        ...
        <div>
            <table style="width:100%;">
                ...
                <td class="auto-style51" style="background-color: #FFCC66">
                    <asp:DropDownList ID="DropDownList3" runat="server" Height="19px" Width="220px">
                    </asp:DropDownList>
                </td>
                </tr>
                <tr>
                ...
                <td class="auto-style52" style="background-color: #FFCC66">
                    <asp:TextBox ID="TextBox4" runat="server" Width="209px" CssClass="auto-style38"></asp:TextBox>
                ...
                <td class="auto-style47" style="background-color: #FFCC66">
                    <asp:DropDownList ID="DropDownList2" runat="server" Height="30px" Width="218px">
                    </asp:DropDownList>
                </td>
                <td class="auto-style50" style="background-color: #FFCC66" colspan="2">Tìm kiếm theo sản phẩm <asp:TextBox ID="TextBox5" runat="server" Height="21px" Width="282px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <td class="auto-style49" style="background-color: #FFCC66">
                    <asp:Button ID="Button8" runat="server" CssClass="auto-style64" Height="42px" Text="Thêm" Width="115px" />
                    <asp:Button ID="Button1" runat="server" CssClass="auto-style64" Height="42px" Text="Sửa" Width="115px" />
                    </td>
                <td class="auto-style57" style="background-color: #FFCC66">
                    <asp:Button ID="Button4" runat="server" CssClass="auto-style64" Height="42px" Text="Xóa" Width="115px" />
                    <asp:Button ID="Button9" runat="server" CssClass="auto-style64" Height="42px" Text="Làm mới" Width="115px" />
                    </td>
                </tr>
                <tr>
                <td class="auto-style58" style="background-color: #FFCC66" colspan="4">
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="1455px">
